...
def main():
    ...
    print("gini")
    column_name1, column_threshold1 = find_best_column_to_split_gini(X)
    print(column_name1)
    print(column_threshold1)

    print("entro")
    column_name2, column_threshold2 = find_best_column_to_split_entropy(X)
    print(column_name2)
    print(column_threshold2)
